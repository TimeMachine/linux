...
raid6_altivec1_gen_syndrome_real(int disks, size_t bytes, void **ptrs)
{
	u8 **dptr = (u8 **)ptrs;
	u8 *p, *q;
	int d, z, z0;
...
static void raid6_altivec1_gen_syndrome(int disks, size_t bytes, void **ptrs)
{
	preempt_disable();
	enable_kernel_altivec();

	raid6_altivec1_gen_syndrome_real(disks, bytes, ptrs);
...
const struct raid6_calls raid6_altivec1 = {
